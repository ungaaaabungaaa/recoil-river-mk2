  ...
  return (
    ...
    >
      ...
      >
        ...
        <aside className="absolute bottom-[clamp(var(--spacing-5),5vw,var(--spacing-12))] left-[clamp(var(--spacing-5),5vw,var(--spacing-12))] z-10 max-[48rem]:bottom-[var(--spacing-6)] max-[48rem]:left-[var(--spacing-6)]">
